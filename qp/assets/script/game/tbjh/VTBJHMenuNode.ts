 ...
 */
@ccclass
export default class VTBJHMenuNode extends VBaseUI {//cc.Component {
    // onLoad () {}
    ...
    start() {
        ...
        if (this.btn_exit != null) {
            ...
            // handler.component = this.getComponent("VTBJHMenuNode");
    ...
    onBtnRecordClick(event) {
        //===================================================
        AppGame.ins.showUI(ECommonUI.TBNN_Record, AppGame.ins.roomModel.requestGameRecords(EGameType.TBJH));
    }
    /**牌型按钮点击事件 */
    onBtnPXClick(event) {
