 ...
 */
@ccclass
export default class VTBJHPlayersNode extends cc.Component {
    ...
    private addEvent() {
        // MTBJHModel.ins.on(UTBJHHelper.TBJH_SELF_EVENT.TBJH_UPDATE_ROLEINFO, this.updateMyRoleInfo, this);
        ...
        MTBJHModel.ins.on(UTBJHHelper.TBJH_SELF_EVENT.TBJH_TOTALSCORE_EVENT, this.onTotalScore, this);

        MTBJHModel.ins.on(UTBJHHelper.TBJH_SELF_EVENT.TBJH_UPDATE_PLAYERS_EVENT, this.onUpdatePlayers, this);
    ...
    private removeEvent() {
        // MTBJHModel.ins.off(UTBJHHelper.TBJH_SELF_EVENT.TBJH_UPDATE_ROLEINFO, this.updateMyRoleInfo, this);
        ...
        MTBJHModel.ins.off(UTBJHHelper.TBJH_SELF_EVENT.TBJH_UPDATE_PLAYERS_EVENT, this.onUpdatePlayers, this);
    ...
    private onResetScene(data?: any) {
        ...
        for (let i = 0; i < this._maxplayer; i++) {
            ...
            {
                var myscore = UTBJHScene.ins.myScore;
                if (myscore == 0) {
        ...
        this.resetPopPos();
        MTBJHModel.ins.updateBattlePlayer();
        //         if (element.seatId == 0) {
    ...
    private onUpdatePlayers(data: any) {
        ...
        for (const key in data) {
            if (data.hasOwnProperty(key)) {
                ...
                // let chairId = MTBJHModel.ins.getUISeatId(element.chairId);
    ...
    private onAddScoreResult(data: Tbnn.NN_CMD_S_AddScoreResult) {
        ...
        //#region  test 0-3 
        // MTBJHModel.ins.sMeChairId = 0;
        //#endregion

        let wAddJettonUser = data.addJettonUser;
        let cbJettonMultiple = data.jettonMultiple;

        let chairId = MTBJHModel.ins.getUISeatId(wAddJettonUser);
    ...
    private onXuanZhuangEnd(data) {
        // var bankindex = MTBJHModel.ins.gBankerIndex;//data.banker;
        // var index = MTBJHModel.ins.getUISeatId(bankindex);
