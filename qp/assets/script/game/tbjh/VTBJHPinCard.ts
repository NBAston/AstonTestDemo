 ...
 */
@ccclass
export default class VTBJHPinCard extends cc.Component {
    ...
    setIsUp(b: boolean) {
        ...
        if(b)
        {
            UTBJHScene.ins.getMusic.playSelect();
        }
    }
    get isUp(): boolean {
        return this._isUp;
        ...
        this.node.on(cc.Node.EventType.TOUCH_END, (event) => {
            ...
            if (!self._isUp) {
                ...
                if (!self._isLock) {
                    ...
                    MTBJHModel.ins.emit(UTBJHHelper.TBJH_SELF_EVENT.TBJH_PINPAI_ADD, self._cardvalue, self._index);
                }
            }
            else {
                ...
                MTBJHModel.ins.emit(UTBJHHelper.TBJH_SELF_EVENT.TBJH_PINPAI_DEL, self._cardvalue, self._index);
            }
