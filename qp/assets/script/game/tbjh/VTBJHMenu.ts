...
export default class VTBJHMenu {
    ...
    private on_record(): void {
        ...
        AppGame.ins.showUI(ECommonUI.LB_Record, EGameType.TBJH);

        // AppGame.ins.showUI(ECommonUI.TBJH_Record, AppGame.ins.roomModel.requestGameRecords(EGameType.TBJH));

        this.closemenu();
    }
    private on_wanfa(): void {
        UTBJHScene.ins.playClick();
        AppGame.ins.showUI(ECommonUI.ZJH_Help, {gameType: EGameType.TBJH});
        this.closemenu();
    }
