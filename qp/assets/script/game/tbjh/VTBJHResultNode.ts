 ...
 */
@ccclass
export default class VTBJHResultNode extends cc.Component {
    /**
     * 4个座位的 输赢分显示节点
     * @param win 正数label
     * @param lose 负数label
    ...
    private showEndScore(data: any,pl:any) {
        ...
        var players = pl;//MTBJHModel.ins.gBattlePlayer;
            ...
            if (iswin) {
                ...
                this._list[index].label.node.runAction(cc.sequence(cc.moveTo(1.0, this._targetPos[index]), cc.callFunc(() => {
                    ...
                    if (this._totalscore[index] != null) {
                        ...
                        MTBJHModel.ins.emit(UTBJHHelper.TBJH_SELF_EVENT.TBJH_TOTALSCORE_EVENT, data);
                    }
                }, this)));
