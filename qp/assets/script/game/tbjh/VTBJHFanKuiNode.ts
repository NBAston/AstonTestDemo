 ...
 */
@ccclass
export default class VTBJHFanKuiNode extends VBaseUI {
    ...
    start() {
        ...
        UEventHandler.addClick(close, this.node, "VTBJHFanKuiNode", "close");

        let btn_yes = UNodeHelper.find(this.node, "qznn_tips_btn2");
        UEventHandler.addClick(btn_yes, this.node, "VTBJHFanKuiNode", "onBtnYesClick");
