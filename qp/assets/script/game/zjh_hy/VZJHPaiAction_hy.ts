...
import { EBattlePlayerPaiState, UIZJHPoker } from "./UZJHClass_hy";
import USpriteFrames from "../../common/base/USpriteFrames";
import UHandler from "../../common/utility/UHandler";
import VZJHFanPaiEffect_hy from "./VZJHFanPaiEffect_hy";
import VZJHPokerAnimation_hy from "./VZJHPokerAnimation_hy";
import { ZJH_SELF_SEAT } from "./MZJH_hy";
 ...
 */
export default class VZJHPaiAction_hy {
    ...
    public _fapaiAct1: VZJHPokerAnimation_hy;
    public _fapaiAct2: VZJHPokerAnimation_hy;
    public _fapaiAct3: VZJHPokerAnimation_hy;
    ...
    constructor(seatId: number, root: cc.Node, fanpan: cc.Node, paixing: cc.Node, res: USpriteFrames) {
        ...
        this.showback();
        this._fapaiAct1 = this._poker1.getComponent(VZJHPokerAnimation_hy);
        this._fapaiAct2 = this._poker2.getComponent(VZJHPokerAnimation_hy);
        this._fapaiAct3 = this._poker3.getComponent(VZJHPokerAnimation_hy);
    ...
    playfapai(start: cc.Vec2, handler?: UHandler): void {
        ...
        this._fapaiAct3.playFapai(start, this._pokerPosX[2], this._oriScale, 0.2, handler);
    }
    /**
     * 播放翻牌动画
     * @param poker 
    ...
    playFanPai(poker: UIZJHPoker, withAnimation: boolean,self:boolean, hander?: UHandler): void {
        ...
        if (withAnimation) {
            ...
            // this._fapaiAct1.playfanpai(this.getRes(this._poker.pokerIcons[0]), 0);
            // this._fapaiAct2.playfanpai(this.getRes(this._poker.pokerIcons[1]), 0.1);
            // this._fapaiAct3.playfanpai(this.getRes(this._poker.pokerIcons[2]), 0.2);
            // this._fapaiAct3.hander = UHandler.create(() => {
            //     this.playpaiPaiover();
            //     if (hander) hander.run();
            // }, this);
    ...
    /**翻牌动作播放完毕 */
    private playpaiPaiover(self:boolean): void {
