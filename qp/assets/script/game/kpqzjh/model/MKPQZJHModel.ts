...
import UKPQZJHHelper, { EQZNNState, QZNNBattlePlayerInfo, MAX_COUNT, OX_FIVE_SMALL, OX_GOLDEN_BULL, OX_BOMB, OX_SILVERY_BULL, OX_VALUE0 } from "../UKPQZJHHelper";
import MBaseGameModel from "../../../public/hall/MBaseGameModel";
import { KPQzjh, Game } from "../../../common/cmd/proto";
 ...
 * 作用:qznn 主要逻辑
 */
export default class MKPQZJHModel extends Model {
    // //大致流程  not use
    // group = {
    ...
    // add by zw
    // 2019年7月29日
    static s_ins: MKPQZJHModel;
    static get ins(): MKPQZJHModel {

        if (MKPQZJHModel.s_ins == null) {
            MKPQZJHModel.s_ins = new MKPQZJHModel();
            MKPQZJHModel.s_ins.init();
        }
        return MKPQZJHModel.s_ins;
    }
    ...
    exit(): void {
        ...
        this.unregesterMsg(KPQzjh.SUBID.SC_GAMESCENE_FREE, new UHandler(this.onGameSceneFree, this));
        this.unregesterMsg(KPQzjh.SUBID.SC_GAMESCENE_CALL, new UHandler(this.onGameSceneCall, this));
        this.unregesterMsg(KPQzjh.SUBID.SC_GAMESCENE_SCORE, new UHandler(this.onGameSceneScore, this));
        this.unregesterMsg(KPQzjh.SUBID.SC_GAMESCENE_OPEN, new UHandler(this.onGameSceneOpen, this));
        // this.regesterMsg(qznn.SUBID.SC_GAMESCENE_END, new UHandler(this.onGameSceneEnd, this));

        this.unregesterMsg(KPQzjh.SUBID.NN_SUB_S_ADD_SCORE_RESULT, new UHandler(this.onAddScoreResult, this));
        this.unregesterMsg(KPQzjh.SUBID.NN_SUB_S_CALL_BANKER, new UHandler(this.onCallBanker, this));
        this.unregesterMsg(KPQzjh.SUBID.NN_SUB_S_CALL_BANKER_RESULT, new UHandler(this.onCallBankerResult, this));
        this.unregesterMsg(KPQzjh.SUBID.NN_SUB_S_GAME_END, new UHandler(this.onGameEnd, this));
        this.unregesterMsg(KPQzjh.SUBID.NN_SUB_S_GAME_START, new UHandler(this.onGameStart, this));
        this.unregesterMsg(KPQzjh.SUBID.NN_SUB_S_OPEN_CARD_RESULT, new UHandler(this.onOpenCardResult, this));
        this.unregesterMsg(KPQzjh.SUBID.NN_SUB_S_SEND_CARD, new UHandler(this.onSendCard, this));

        this.unregesterMsg(KPQzjh.SUBID.NN_SUB_C_ROUND_END_EXIT_RESULT, new UHandler(this.onNextExit , this));
    ...
    qznnRegest() {
        ...
        this.regesterMsg(KPQzjh.SUBID.SC_GAMESCENE_FREE, new UHandler(this.onGameSceneFree, this));
        this.regesterMsg(KPQzjh.SUBID.SC_GAMESCENE_CALL, new UHandler(this.onGameSceneCall, this));
        this.regesterMsg(KPQzjh.SUBID.SC_GAMESCENE_SCORE, new UHandler(this.onGameSceneScore, this));
        this.regesterMsg(KPQzjh.SUBID.SC_GAMESCENE_OPEN, new UHandler(this.onGameSceneOpen, this));
        // this.regesterMsg(qznn.SUBID.SC_GAMESCENE_END, new UHandler(this.onGameSceneEnd, this));

        this.regesterMsg(KPQzjh.SUBID.NN_SUB_S_ADD_SCORE_RESULT, new UHandler(this.onAddScoreResult, this));
        this.regesterMsg(KPQzjh.SUBID.NN_SUB_S_CALL_BANKER, new UHandler(this.onCallBanker, this));
        this.regesterMsg(KPQzjh.SUBID.NN_SUB_S_CALL_BANKER_RESULT, new UHandler(this.onCallBankerResult, this));
        this.regesterMsg(KPQzjh.SUBID.NN_SUB_S_GAME_END, new UHandler(this.onGameEnd, this));
        this.regesterMsg(KPQzjh.SUBID.NN_SUB_S_GAME_START, new UHandler(this.onGameStart, this));
        this.regesterMsg(KPQzjh.SUBID.NN_SUB_S_OPEN_CARD_RESULT, new UHandler(this.onOpenCardResult, this));
        this.regesterMsg(KPQzjh.SUBID.NN_SUB_S_SEND_CARD, new UHandler(this.onSendCard, this));

        this.regesterMsg(KPQzjh.SUBID.NN_SUB_C_ROUND_END_EXIT_RESULT, new UHandler(this.onNextExit , this));
    ...
    regesterMsg(subId: number, handler: UHandler) {
        UMsgCenter.ins.regester(EGameType.KPQZJH,
    ...
    unregesterMsg(subId: number, handler: UHandler) {
        UMsgCenter.ins.unregester(EGameType.KPQZJH,
            Game.Common.MAINID.MAIN_MESSAGE_CLIENT_TO_GAME_LOGIC,
            subId,
            handler);
    }
    ...
    sendMsg(subId: number, data: any, handler: UHandler = null, unlock: boolean = false) {
        UMsgCenter.ins.sendPkg(EGameType.KPQZJH,
            Game.Common.MAINID.MAIN_MESSAGE_CLIENT_TO_GAME_LOGIC,
    ...
    //         case MKPQZJHModel.QZNN_GAMESTATUS.FREE:
    //             {
    ...
    /**
     * 设置所有场景内玩家状态
     * @param gameStatus MKPQZJHModel.QZNN_GAMESTATUS状态
    ...
    private setAllSceneStatus(gameStatus: number, state: EQZNNState, cbPlayStatus?: number[]) {
        ...
        this._gameStatus = MKPQZJHModel.QZNN_GAMESTATUS.FREE;
        //如果是上座玩牌玩家，重新赋状态
        if (this._battleplayer[this.selfUserId] != null
            ...
            this._gameStatus = gameStatus;//MKPQZJHModel.QZNN_GAMESTATUS.CALL;
        }
    }
    /**设置房间内玩家信息 */
    ...
    public updateBattlePlayer() {
        UDebug.Log("更新玩家信息----------------------------"+this._battleplayer)
        this.emit(UKPQZJHHelper.QZNN_SELF_EVENT.QZNN_UPDATE_PLAYERS_EVENT, this._battleplayer);
    }
            ...
            for (let i = 0; i < dTotalScore.length; i++) { 
                ...
                if(index == 0) {
                    ...
                    for (let index = 0; index < keys.length; index++) {
                        const element = this._battleplayer[keys[index]];
                        if(element.seatId == index) {
                            this._battleplayer[keys[index]].score = dTotalScore[i];
                        }
                    }
                }
            }
    ...
    private onGameSceneFree(data: any) {
        ...
        this.emit(UKPQZJHHelper.QZNN_EVENT.QZNN_GAMESCENE_FREE, data, ishideContinue);
    ...
    onGameSceneCall(data: any) {
        ...
        this._currentDizhu = data.cellScore || 1;
        this.setRoomPlayersInfo();
        this.setAllSceneStatus(MKPQZJHModel.QZNN_GAMESTATUS.CALL, EQZNNState.Gameing, cbPlayStatus);
        this.emit(UKPQZJHHelper.QZNN_EVENT.QZNN_GAMESCENE_CALL, data);
        this.updateBattlePlayer();
        this.emit(UKPQZJHHelper.QZNN_SELF_EVENT.QZNN_UPDATE_ROOMID, roomId);
    ...
    onGameSceneScore(data: any) {
        ...
        this.setAllSceneStatus(MKPQZJHModel.QZNN_GAMESTATUS.SCORE, EQZNNState.Gameing, cbPlayStatus);

        this.emit(UKPQZJHHelper.QZNN_EVENT.QZNN_GAMESCENE_SCORE, data);
    ...
    onGameSceneOpen(data: any) {
        ...
        this.setAllSceneStatus(MKPQZJHModel.QZNN_GAMESTATUS.OPEN, EQZNNState.Gameing, cbPlayStatus);

        this.emit(UKPQZJHHelper.QZNN_EVENT.QZNN_GAMESCENE_OPEN, data);
    ...
    private sc_ts_player_left_room(data: any) {
        ...
        if (data.retCode == 0) {
            ...
            if (data.type == ELeftType.ReturnToRoom) {
                ...
                this.emit(UKPQZJHHelper.QZNN_SELF_EVENT.QZNN_SC_TS_CANCLE_MATCH, true);
                this._state = EQZNNState.Wait;
                ...
                this.emit(UKPQZJHHelper.QZNN_SELF_EVENT.QZNN_SC_TS_START_MATCH, true);
            }

        }
        // else if (data.retCode == 2) {
        //     this.emit(UKPQZJHHelper.QZNN_SELF_EVENT.QZNN_CONTINUE_ACTIVE, true);
        // }
        else {
            if (data.type == ELeftType.ReturnToRoom) {
                this._retrunLobby = false;
                ...
                if (this._state != EQZNNState.Gameing) {
                    this.emit(UKPQZJHHelper.QZNN_SELF_EVENT.QZNN_SC_TS_CANCLE_MATCH, false);
                }
                ...
                this.emit(UKPQZJHHelper.QZNN_SELF_EVENT.QZNN_SC_TS_START_MATCH, false);
            }
    ...
    onGameStart(data: any) {
        ...
        this.emit(UKPQZJHHelper.QZNN_EVENT.QZNN_GAME_START, data);
        this.updateBattlePlayer();
    ...
    onCallBanker(data: any) {
        this.emit(UKPQZJHHelper.QZNN_EVENT.QZNN_CALL_BANKER, data);
        this._state = EQZNNState.Gameing;
    ...
    onCallBankerResult(data: any) {
        this.emit(UKPQZJHHelper.QZNN_EVENT.QZNN_CALL_BANKER_RESULT, data);
        this._state = EQZNNState.Gameing;
    ...
    onAddScoreResult(data: any) {  // private
        ...
        this.emit(UKPQZJHHelper.QZNN_EVENT.QZNN_ADD_SCORE_RESULT, data);
        this._state = EQZNNState.Gameing;
    ...
    /**发牌消息 */
    onSendCard(data: any) {
        this.emit(UKPQZJHHelper.QZNN_EVENT.QZNN_SEND_CARD, data);
        this._state = EQZNNState.Gameing;
    ...
    onOpenCardResult(data: any) {
        this.emit(UKPQZJHHelper.QZNN_EVENT.QZNN_OPEN_CARD_RESULT, data);
        this._state = EQZNNState.Gameing;
    ...
    onGameEnd(data: any) {
        ...
        this.emit(UKPQZJHHelper.QZNN_EVENT.QZNN_GAME_END, data);
        this.emit(UKPQZJHHelper.QZNN_SELF_EVENT.QZNN_DJS_EVENT, 0);
    ...
    onNextExit(data: any) {
        UDebug.log(data);
        this.emit(UKPQZJHHelper.QZNN_SELF_EVENT.QZNN_NEXT_EXIT, data);
    ...
    sendAddScore(jetton: number) {
        ...
        this.sendMsg(KPQzjh.SUBID.NN_SUB_C_ADD_SCORE, data);
    }
    /**
     * 请求叫庄
     * @param callFlag 
    ...
    sendCallBanker(callFlag: number) {
        ...
        this.sendMsg(KPQzjh.SUBID.NN_SUB_C_CALL_BANKER, data);
    }

    /**请求开牌 */
    sendOpenCard() {
        this.sendMsg(KPQzjh.SUBID.NN_SUB_C_OPEN_CARD, {});
    }
    ...
    sendNextExit(b: boolean): void {
        ...
        this.sendMsg(KPQzjh.SUBID.NN_SUB_C_ROUND_END_EXIT, data);
    }
    ...
    public getCardSuit(card: number): number {
        return (card & MKPQZJHModel.LOGIC_MASK.COLOR) >> 4;
    }
    /**获取一副完整的牌 not use*/
    ...
    public getCardValue(card: number): number {
        return card & MKPQZJHModel.LOGIC_MASK.VALUE;
    }
