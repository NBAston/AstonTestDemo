 ...
 */
@ccclass
export default class VXPQZNNRoot extends cc.Component {

    // public static Instance: VQZNNRoot = new VQZNNRoot(); //readonly

    /**打开开始说明界面 */
    private opensm(): void {
        // if (!AppGame.ins.xpqznnModel.gIsOpenSM)
    ...
    private addEvent() {
        // AppGame.ins.xpqznnModel.on(UQZNNHelper.QZNN_SELF_EVENT.QZNN_SM_OPEN, this.openSMPanel, this);
        // cc.systemEvent.on(UQZNNHelper.QZNN_SELF_EVENT.QZNN_PIPEI, this.showPiPeiPanel, this);
    }

    private removeEvent(){
        // AppGame.ins.xpqznnModel.off(UQZNNHelper.QZNN_SELF_EVENT.QZNN_SM_OPEN, this.openSMPanel, this);
    }
    ...
    //     AppGame.ins.xpqznnModel.emit(, data);
    // }
