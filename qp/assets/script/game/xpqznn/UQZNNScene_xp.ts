...
import VQZNNMatch from "./VQZNNMatch_xp";
import { ECommonUI, ELevelType, EGameType, EEnterRoomErrCode } from "../../common/base/UAllenum";
import ULanHelper from "../../common/utility/ULanHelper";
import UHandler from "../../common/utility/UHandler";
import UQZNNHelper, { UQZNNCmd, EQZNNState } from "./UQZNNHelper_xp";
import { ToBattle } from "../../common/base/UAllClass";
import UQZNNMusic from "./UQZNNMusic_xp";
import VQZNNMenu from "./VQZNNMenu_xp";
...
@ccclass
export default class UXPQZNNScene extends UGame {//UScene {

    /**单例 */
    private static _ins: UXPQZNNScene;
    static get ins(): UXPQZNNScene {
        return UXPQZNNScene._ins;
    }
    /**图片资源 */
    ...
    protected init(): void {
        ...
        UEventHandler.addClick(this.qznn_pjbg, this.node, "UXPQZNNScene", "oncopy");
        UEventHandler.addClick(this._charge_btn,this.node,"UXPQZNNScene","intoCharge");
    ...
    openScene(data: any): void {
        ...
        AppGame.ins.xpqznnModel.setPlayerInfo(roleinfo);

        // UDebug.log(AppGame.ins.xpqznnModel.getPlayerInfo());
        // this.getRoomPlayers();


        if (data) {
            let dt = data as ToBattle;
            AppGame.ins.xpqznnModel.saveRoomInfo(dt.roomData);
            if (dt) {
                AppGame.ins.xpqznnModel.currentDizhu = dt.roomData.floorScore;
                if (!dt.fromReconnet) {
                    this.waitbattle();
                    // this.delayTimerToMatch();
                }
                else {
                    AppGame.ins.xpqznnModel.emit(UQZNNHelper.QZNN_SELF_EVENT.QZNN_RESET_SCENE);
    ...
    private addEvent() {
        AppGame.ins.xpqznnModel.on(UQZNNHelper.QZNN_EVENT.QZNN_GAME_START, this.onGameStart, this);
        AppGame.ins.xpqznnModel.on(UQZNNHelper.QZNN_EVENT.QZNN_CALL_BANKER, this.onCallBanker, this);
        AppGame.ins.xpqznnModel.on(UQZNNHelper.QZNN_EVENT.QZNN_CALL_BANKER_RESULT, this.onCallBankerResult, this);
        AppGame.ins.xpqznnModel.on(UQZNNHelper.QZNN_EVENT.QZNN_ADD_SCORE_RESULT, this.onAddScoreResult, this);
        AppGame.ins.xpqznnModel.on(UQZNNHelper.QZNN_EVENT.QZNN_SEND_CARD, this.onSendCard, this);
        AppGame.ins.xpqznnModel.on(UQZNNHelper.QZNN_EVENT.QZNN_OPEN_CARD_RESULT, this.onOpenCardResult, this);
        AppGame.ins.xpqznnModel.on(UQZNNHelper.QZNN_EVENT.QZNN_GAME_END, this.onGameEnd, this);

        AppGame.ins.xpqznnModel.on(UQZNNHelper.QZNN_EVENT.QZNN_GAMESCENE_FREE, this.onGameSceneFree, this);
        AppGame.ins.xpqznnModel.on(UQZNNHelper.QZNN_EVENT.QZNN_GAMESCENE_CALL, this.onGameSceneCall, this);
        AppGame.ins.xpqznnModel.on(UQZNNHelper.QZNN_EVENT.QZNN_GAMESCENE_SCORE, this.onGameSceneScore, this);
        AppGame.ins.xpqznnModel.on(UQZNNHelper.QZNN_EVENT.QZNN_GAMESCENE_OPEN, this.onGameSceneOpen, this);

        AppGame.ins.xpqznnModel.on(UQZNNHelper.QZNN_EVENT.QZNN_GAMESCENE_SELECT, this.onGameSceneSeletct, this);
        

        AppGame.ins.xpqznnModel.on(UQZNNHelper.QZNN_SELF_EVENT.QZNN_MOVE_NEXT_CMD, this.onMoveNextCmd, this);
        AppGame.ins.xpqznnModel.on(UQZNNHelper.QZNN_SELF_EVENT.QZNN_UPDATE_ROOMID, this.onUpdateRoomId, this);
        AppGame.ins.xpqznnModel.on(UQZNNHelper.QZNN_SELF_EVENT.QZNN_START_ANI_COMPLETE, this.onStartAniComplete, this);
        AppGame.ins.xpqznnModel.on(UQZNNHelper.QZNN_SELF_EVENT.QZNN_FAPAI_COMPLETE, this.onFaPaiAniComplete, this);

        AppGame.ins.xpqznnModel.on(UQZNNHelper.QZNN_SELF_EVENT.QZNN_SC_TS_START_MATCH, this.sc_ts_start_match, this);
        // AppGame.ins.xpqznnModel.on(UQZNNHelper.QZNN_SELF_EVENT.QZNN_SC_TS_SHOW_MATCH, this.sc_ts_show_match, this);
        AppGame.ins.xpqznnModel.on(UQZNNHelper.QZNN_SELF_EVENT.QZNN_SC_TS_CANCLE_MATCH, this.set_cancel_match, this);

        AppGame.ins.xpqznnModel.on(UQZNNHelper.QZNN_EVENT.QZNN_SEND_SELECT_CARD, this.onSelectCard, this);
        
        AppGame.ins.xpqznnModel.run();

    }
    private removeEvent() {
        AppGame.ins.xpqznnModel.off(UQZNNHelper.QZNN_EVENT.QZNN_GAME_START, this.onGameStart, this);
        AppGame.ins.xpqznnModel.off(UQZNNHelper.QZNN_EVENT.QZNN_CALL_BANKER, this.onCallBanker, this);
        AppGame.ins.xpqznnModel.off(UQZNNHelper.QZNN_EVENT.QZNN_CALL_BANKER_RESULT, this.onCallBankerResult, this);
        AppGame.ins.xpqznnModel.off(UQZNNHelper.QZNN_EVENT.QZNN_ADD_SCORE_RESULT, this.onAddScoreResult, this);
        AppGame.ins.xpqznnModel.off(UQZNNHelper.QZNN_EVENT.QZNN_SEND_CARD, this.onSendCard, this);
        AppGame.ins.xpqznnModel.off(UQZNNHelper.QZNN_EVENT.QZNN_OPEN_CARD_RESULT, this.onOpenCardResult, this);
        AppGame.ins.xpqznnModel.off(UQZNNHelper.QZNN_EVENT.QZNN_GAME_END, this.onGameEnd, this);

        AppGame.ins.xpqznnModel.off(UQZNNHelper.QZNN_EVENT.QZNN_GAMESCENE_FREE, this.onGameSceneFree, this);
        AppGame.ins.xpqznnModel.off(UQZNNHelper.QZNN_EVENT.QZNN_GAMESCENE_CALL, this.onGameSceneCall, this);
        AppGame.ins.xpqznnModel.off(UQZNNHelper.QZNN_EVENT.QZNN_GAMESCENE_SCORE, this.onGameSceneScore, this);
        AppGame.ins.xpqznnModel.off(UQZNNHelper.QZNN_EVENT.QZNN_GAMESCENE_OPEN, this.onGameSceneOpen, this);

        AppGame.ins.xpqznnModel.off(UQZNNHelper.QZNN_EVENT.QZNN_GAMESCENE_SELECT, this.onGameSceneSeletct, this);

        AppGame.ins.xpqznnModel.off(UQZNNHelper.QZNN_SELF_EVENT.QZNN_MOVE_NEXT_CMD, this.onMoveNextCmd, this);
        AppGame.ins.xpqznnModel.off(UQZNNHelper.QZNN_SELF_EVENT.QZNN_UPDATE_ROOMID, this.onUpdateRoomId, this);
        AppGame.ins.xpqznnModel.off(UQZNNHelper.QZNN_SELF_EVENT.QZNN_START_ANI_COMPLETE, this.onStartAniComplete, this);
        AppGame.ins.xpqznnModel.off(UQZNNHelper.QZNN_SELF_EVENT.QZNN_FAPAI_COMPLETE, this.onFaPaiAniComplete, this);

        AppGame.ins.xpqznnModel.off(UQZNNHelper.QZNN_SELF_EVENT.QZNN_SC_TS_START_MATCH, this.sc_ts_start_match, this);
        // AppGame.ins.xpqznnModel.off(UQZNNHelper.QZNN_SELF_EVENT.QZNN_SC_TS_SHOW_MATCH, this.sc_ts_show_match, this);
        AppGame.ins.xpqznnModel.off(UQZNNHelper.QZNN_SELF_EVENT.QZNN_SC_TS_CANCLE_MATCH, this.set_cancel_match, this);
        AppGame.ins.xpqznnModel.off(UQZNNHelper.QZNN_EVENT.QZNN_SEND_SELECT_CARD, this.onSelectCard, this);
        AppGame.ins.xpqznnModel.exit();
    }
    ...
    private showgameinfo(value: boolean): void {
        ...
        AppGame.ins.xpqznnModel.emit(UQZNNHelper.QZNN_SELF_EVENT.QZNN_GAMEINFO_ACTIVE, value);
    }
    /**进入房间失败 */
    protected enter_room_fail(errorCode: number, errorMsg?: any): void {
        ...
        switch (errorCode) {
            case EEnterRoomErrCode.ERROR_ENTERROOM_GAME_IS_END:
                ...
                //         this.waitbattle();
                //         AppGame.ins.xpqznnModel.requestMatch();
                //     }, this)
                // });
            ...
            case EEnterRoomErrCode.ERROR_ENTERROOM_TABLE_FULL:
                {
                    ...
                    AppGame.ins.xpqznnModel.emit(UQZNNHelper.QZNN_SELF_EVENT.QZNN_RESET_SCENE);
                    AppGame.ins.xpqznnModel.emit(UQZNNHelper.QZNN_SELF_EVENT.QZNN_CONTINUE_ACTIVE, true);
                    ...
                    this.scheduleOnce(() => {
                        AppGame.ins.showUI(ECommonUI.NewMsgBox, {
                            type: 1, data: msg, handler: UHandler.create(() => {
                                AppGame.ins.loadLevel(ELevelType.Hall, EGameType.XPQZNN);
                            }, this)
                        });
                    }, 3);
                }
    ...
    private do_no_in_game() {
        ...
        // this.waitbattle();
        // AppGame.ins.xpqznnModel.reconnectRequest();

        this._cmds = [];
        this._canGetCmd = true;

        AppGame.ins.xpqznnModel.setReconnectState(EQZNNState.Wait, true);
    ...
    private setDiZhu(num?: number, b?: boolean) {
        num = AppGame.ins.xpqznnModel.currentDizhu;
        if (num != null) {
    ...
    private setDjs(time: number , djs_type?: string) {
        if (time != null) {
            AppGame.ins.xpqznnModel.emit(UQZNNHelper.QZNN_SELF_EVENT.QZNN_DJS_EVENT, time , null , djs_type);
        }
    }
    ...
    /************* scene *****************/
    onGameSceneFree(data: XPQznn.NN_MSG_GS_FREE, ishideContinue: boolean = false) {
        var dCellScore = data.cellScore || AppGame.ins.xpqznnModel.currentDizhu;//基础积分
    ...
    onGameSceneCall(data: XPQznn.NN_MSG_GS_CALL) {
        this.setMatch(false);
        ...
        if (sCallBanker != null) { //&& cbCallBankerMultiple != null
            ...
            for (let i = 0; i < count; i++) {
                ...
                if (callbanker >= 0) {
                    let dt = new XPQznn.NN_CMD_S_CallBanker();
                    dt.callBankerUser = i;
    ...
    onGameSceneScore(data: XPQznn.NN_MSG_GS_SCORE) {
        this.setMatch(false);
        ...
        if (cbUserJettonMultiple != null) {
            ...
            for (let j = 0; j < count; j++) {
                ...
                if (addscoreuser > 0) {
                    let dt2 = new XPQznn.NN_CMD_S_AddScoreResult();
                    dt2.addJettonUser = j;
    ...
    onGameSceneSeletct(data: XPQznn.NN_MSG_GS_SELCARD) {
        this.setMatch(false);
        ...
        AppGame.ins.xpqznnModel.emit(UQZNNHelper.QZNN_SELF_EVENT.QZNN_SELECT_CARD, data,data.selectedCard);
        // this.setDjs(cbTimeLeave);
    ...
    onGameSceneOpen(data: XPQznn.NN_MSG_GS_OPEN) {
        this.setMatch(false);
        ...
        AppGame.ins.xpqznnModel.emit(UQZNNHelper.QZNN_SELF_EVENT.QZNN_SC_GAMESCENE_OPEN, data);
        AppGame.ins.xpqznnModel.emit(UQZNNHelper.QZNN_SELF_EVENT.QZNN_SELECT_CARD, data,data.selectedCard);
        //发牌
        var myIndex = AppGame.ins.xpqznnModel.gMeChairId;
        ...
        // AppGame.ins.xpqznnModel.emit(UQZNNHelper.QZNN_SELF_EVENT.QZNN_SCENE_OPEN_NOT_SEND_CARD
        ...
        if (cbIsOpenCard != null) {
            for (let k = 0; k < cbIsOpenCard.length; k++) {
                ...
                if (isopen) {//已开牌
                    ...
                    let dt4 = new XPQznn.NN_CMD_S_OpenCardResult();
                    dt4.openCardUser = k;
    ...
    // onGameSceneEnd(data) {
    //     AppGame.ins.xpqznnModel.onGameSceneEnd(data);
    ...
    //发牌消息 
    private onSendCard(data: XPQznn.NN_CMD_S_SendCard) {
    ...
    //显示选牌、
    private onSelectCard(data: XPQznn.NN_CMD_S_SendSelCard) {
        UDebug.log("显示选牌、    onSelectCardResult")
        this.pushcmd("show_select_pai", data, true);
    }

    private do_show_select_pai(data: XPQznn.NN_CMD_S_SendSelCard) {
        UDebug.log("显示选牌、    时间",data.selCardTime)
        AppGame.ins.xpqznnModel.emit(UQZNNHelper.QZNN_SELF_EVENT.QZNN_SUB_S_SEND_CARD, data);
    ...
    //游戏结束 
    private onGameEnd(data:XPQznn.NN_CMD_S_GameEnd) {
        let pl = AppGame.ins.xpqznnModel.CopyBattlePlayer;
        if (cc.sys.isNative) {
            var self = this;
            this.scheduleOnce(() => {
    ...
    /************* do  *******************/
    private do_game_start(data: XPQznn.NN_CMD_S_GameStart) {

        AppGame.ins.xpqznnModel.emit(UQZNNHelper.QZNN_SELF_EVENT.QZNN_RESET_SCENE);

        AppGame.ins.xpqznnModel.emit(UQZNNHelper.QZNN_SELF_EVENT.QZNN_SUB_S_GAME_START, data);
    ...
    private do_call_banker(data: XPQznn.NN_CMD_S_CallBanker) {
        AppGame.ins.xpqznnModel.emit(UQZNNHelper.QZNN_SELF_EVENT.QZNN_SUB_S_CALL_BANKER, data);
    ...
    private do_call_banker_result(data: XPQznn.NN_CMD_S_CallBankerResult) {
        AppGame.ins.xpqznnModel.emit(UQZNNHelper.QZNN_SELF_EVENT.QZNN_SUB_S_CALL_BANKER_RESULT, data);
        ...
        var myPl = AppGame.ins.xpqznnModel.gMeChairId;
    ...
    private do_xia_zhu(data: XPQznn.NN_CMD_S_AddScoreResult) {
        AppGame.ins.xpqznnModel.emit(UQZNNHelper.QZNN_SELF_EVENT.QZNN_SUB_S_ADD_SCORE_RESULT, data);

        let addJettonUser = data.addJettonUser;
        //是自己的结果
        if (addJettonUser == AppGame.ins.xpqznnModel.gMeChairId) {
    ...
    private do_fapai(data: XPQznn.NN_CMD_S_SendCard) {
        UDebug.log("发牌  do_fapai"+data)
        AppGame.ins.xpqznnModel.emit(UQZNNHelper.QZNN_SELF_EVENT.QZNN_SUB_S_SEND_CARD1, data);
    ...
    private do_look_pai(data: XPQznn.NN_CMD_S_OpenCardResult) {
        UDebug.Log("do_look_pai:" + JSON.stringify(data));
        AppGame.ins.xpqznnModel.emit(UQZNNHelper.QZNN_SELF_EVENT.QZNN_SUB_S_OPEN_CARD_RESULT, data);

        var wOpenCardUser = data.openCardUser;
        if (wOpenCardUser == AppGame.ins.xpqznnModel.gMeChairId) {
    ...
    private do_game_end(dt: any) {
        // this.setDjs(0);
        let data:XPQznn.NN_CMD_S_GameEnd=dt.dt;
        AppGame.ins.xpqznnModel.emit(UQZNNHelper.QZNN_SELF_EVENT.QZNN_SUB_S_GAME_END, data,dt.pl);
        this.setLabelTip(false);
        ...
        if (dTotalScore != null) {
            for (let i = 0; i < dTotalScore.length; i++) {
                ...
                let index = AppGame.ins.xpqznnModel.getUISeatId(i);
                if (index == 0) {
    ...
    //     AppGame.ins.xpqznnModel.onOperateFail(data);
    ...
    // onTongSha() {
    //     AppGame.ins.xpqznnModel.emit(UQZNNHelper.QZNN_SELF_EVENT.QZNN_TONGSHA_EVENT);
    // }

    // onTongPei() {
    //     AppGame.ins.xpqznnModel.emit(UQZNNHelper.QZNN_SELF_EVENT.QZNN_TONGPEI_EVENT);
    // }
