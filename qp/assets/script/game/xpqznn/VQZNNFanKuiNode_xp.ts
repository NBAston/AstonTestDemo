 ...
 */
@ccclass
export default class VXPQZNNFanKuiNode extends VBaseUI {
    ...
    start() {
        ...
        UEventHandler.addClick(close, this.node, "VQZNNFanKuiNode", "close");

        let btn_yes = UNodeHelper.find(this.node, "qznn_tips_btn2");
        UEventHandler.addClick(btn_yes, this.node, "VQZNNFanKuiNode", "onBtnYesClick");
