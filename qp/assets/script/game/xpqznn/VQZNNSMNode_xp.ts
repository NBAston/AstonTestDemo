...
import { EQZNNUIzIndex } from "./UQZNNHelper_xp";
 ...
 */
@ccclass
export default class VXPQZNNSMNode extends VBaseUI {
    ...
    start () {
        ...
        UEventHandler.addClick(btn_close, this.node, "VQZNNSMNode_xp", "onBtnCloseClick");
    ...
    show(data:any){
        ...
        AppGame.ins.xpqznnModel.sIsOpenSM = true;
    }
