 ...
 */
@ccclass
export default class VXPQZNNPinCard extends cc.Component {
    ...
    setIsUp(b: boolean) {
        ...
        if(b)
        {
            UQZNNScene.ins.getMusic.playSelect();
        }
    }
    get isUp(): boolean {
        return this._isUp;
        ...
        this.node.on(cc.Node.EventType.TOUCH_END, (event) => {
            ...
            if (!self._isUp) {
                ...
                if (!self._isLock) {
                    ...
                    AppGame.ins.xpqznnModel.emit(UQZNNHelper.QZNN_SELF_EVENT.QZNN_PINPAI_ADD, self._cardvalue, self._index);
                }
            }
            else {
                ...
                AppGame.ins.xpqznnModel.emit(UQZNNHelper.QZNN_SELF_EVENT.QZNN_PINPAI_DEL, self._cardvalue, self._index);
            }
