...
import { EQZNNUIzIndex } from "./UKPQZNNHelper";
 ...
 */
@ccclass
export default class VKPQZNNSMNode extends VBaseUI {
    ...
    start () {
        ...
        UEventHandler.addClick(btn_close, this.node, "VKPQZNNSMNode", "onBtnCloseClick");
    ...
    show(data:any){
        ...
        MKPQZNNModel.ins.sIsOpenSM = true;
    }
