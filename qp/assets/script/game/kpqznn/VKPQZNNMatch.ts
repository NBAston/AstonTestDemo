 ...
 */
@ccclass
export default class VKPQZNNMatch extends cc.Component {
    ...
    init(): void {
        ...
        UEventHandler.addClick(btnClos, this.node, "VKPQZNNMatch", "closeMatch");
    ...
    private closeMatch(): void {
        ...
        // MKPQZNNModel.ins.cancleMatch();
        MKPQZNNModel.ins.exitGame();
    }
