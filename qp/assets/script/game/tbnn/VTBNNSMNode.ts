...
import { ETBNNUIzIndex } from "./UTBNNHelper";
 ...
 */
@ccclass
export default class VTBNNSMNode extends VBaseUI {
    ...
    start () {
        ...
        UEventHandler.addClick(btn_close, this.node, "VTBNNSMNode", "onBtnCloseClick");
