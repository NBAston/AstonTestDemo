 ...
 */
@ccclass
export default class VTBNNHelpNode extends VBaseUI {// cc.Component {
    /**关闭按钮 */
    @property(cc.Button)
    ...
    onLoad() {
        ...
        UEventHandler.addToggle(this._toggle0.node,this.node,"VTBNNHelpNode","onCheckEvent",0);
        UEventHandler.addToggle(this._toggle1.node,this.node,"VTBNNHelpNode","onCheckEvent",1);
        UEventHandler.addToggle(this._toggle2.node,this.node,"VTBNNHelpNode","onCheckEvent",2);
        UEventHandler.addToggle(this._toggle3.node,this.node,"VTBNNHelpNode","onCheckEvent",3);
        UEventHandler.addToggle(this._toggle4.node,this.node,"VTBNNHelpNode","onCheckEvent",4);
