 ...
 */
@ccclass
export default class VTBNNPinCard extends cc.Component {
    ...
    setIsUp(b: boolean) {
        ...
        if(b)
        {
            UTBNNScene.ins.getMusic.playSelect();
        }
    }
    get isUp(): boolean {
        return this._isUp;
        ...
        this.node.on(cc.Node.EventType.TOUCH_END, (event) => {
            ...
            if (!self._isUp) {
                ...
                if (!self._isLock) {
                    ...
                    MTBNNModel.ins.emit(UTBNNHelper.TBNN_SELF_EVENT.TBNN_PINPAI_ADD, self._cardvalue, self._index);
                }
            }
            else {
                ...
                MTBNNModel.ins.emit(UTBNNHelper.TBNN_SELF_EVENT.TBNN_PINPAI_DEL, self._cardvalue, self._index);
            }
