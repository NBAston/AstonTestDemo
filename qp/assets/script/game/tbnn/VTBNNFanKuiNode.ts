 ...
 */
@ccclass
export default class VTBNNFanKuiNode extends VBaseUI {
    ...
    start() {
        ...
        UEventHandler.addClick(close, this.node, "VTBNNFanKuiNode", "close");

        let btn_yes = UNodeHelper.find(this.node, "qznn_tips_btn2");
        UEventHandler.addClick(btn_yes, this.node, "VTBNNFanKuiNode", "onBtnYesClick");
