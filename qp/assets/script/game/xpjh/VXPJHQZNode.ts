 ...
 */
@ccclass
export default class VXPJHQZNode extends cc.Component {
    ...
    private addEvent() {
        ...
        UEventHandler.addClick(this._btnBuQiang.node,
            this.node, "VXPJHQZNode", "sendBeiShuInfo", 0);
        ...
        // AppGame.ins.xpqzjhModel.on(UXPJHHelper.QZNN_SELF_EVENT.QZNN_OPEN_QIANGZHUANG, this.openQiangZhuangPanel, this);
    ...
    private removeEvent(){
        ...
        // AppGame.ins.xpqzjhModel.off(UXPJHHelper.QZNN_SELF_EVENT.QZNN_OPEN_QIANGZHUANG, this.openQiangZhuangPanel, this);
    ...
    private sendBeiShuInfo(event, customEventData) {
        ...
        AppGame.ins.xpqzjhModel.sendCallBanker(customEventData);
    }
    ...
    private onCallBanker(data: XPQzjh.NN_CMD_S_CallBanker) {
        ...
        // cc.log("gMeChairId :" + AppGame.ins.xpqzjhModel.gMeChairId);
            ...
            for (let i = 0; i < cbCallBankerMultiple.length; i++) {
                ...
                if (cbCallBankerMultiple[i] > 0) {
                    ...
                    UEventHandler.addClick(this._qznnList[i.toString()].btn.node,
                        this.node, "VXPJHQZNode", "sendBeiShuInfo", cbCallBankerMultiple[i]);
                }
                else {
