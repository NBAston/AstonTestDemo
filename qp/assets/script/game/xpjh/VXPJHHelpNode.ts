 ...
 */
@ccclass
export default class VXPJHHelpNode extends VBaseUI {// cc.Component {
    /**关闭按钮 */
    @property(cc.Button)
    ...
    onLoad() {
        ...
        UEventHandler.addToggle(this._toggle0.node,this.node,"VXPJHHelpNode","onCheckEvent",0);
        UEventHandler.addToggle(this._toggle1.node,this.node,"VXPJHHelpNode","onCheckEvent",1);
        UEventHandler.addToggle(this._toggle2.node,this.node,"VXPJHHelpNode","onCheckEvent",2);
        UEventHandler.addToggle(this._toggle3.node,this.node,"VXPJHHelpNode","onCheckEvent",3);
