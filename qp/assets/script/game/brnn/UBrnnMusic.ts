...
export default class UBrnnMusic {
/**
     *音乐资源
     */
    ...
    playPaiXing(paixing: string): void {
        UAudioManager.ins.playGameSound(AppGame.ins.roomModel.BundleName,'audio_brnn_woman_' + paixing);
    }
    playGamebg(): void {
        UAudioManager.ins.playGameMusic(AppGame.ins.roomModel.BundleName,'audio_brnn_bgm');
    }
    playflyCoin(): void {
