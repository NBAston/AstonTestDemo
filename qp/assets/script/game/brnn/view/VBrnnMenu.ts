...
@ccclass
export default class VBrnnMenu extends cc.Component {
    ...
    private onClickJiLv() {
        UAudioManager.ins.playSound("audio_click");
        AppGame.ins.showUI(ECommonUI.LB_Record, EGameType.BRNN);
    ...
    private onClickHelp() {
        UAudioManager.ins.playSound("audio_click");
        AppGame.ins.showUI(ECommonUI.ZJH_Help, {gameType: EGameType.BRNN});
