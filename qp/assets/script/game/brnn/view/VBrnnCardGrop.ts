...
import cfg_brnn_type from "../cfg_brnn_type";
...
const GoldRate = 100;
export default class VBrnnCardGrop {
    ...
    private _music_mgr: UBrnnMusic = null;
    ...
    constructor(root: cc.Node,  music_mgr: UBrnnMusic) {
    ...
    showType(type: number, is_win: boolean = true) {
        ...
        this._music_mgr.playPaiXing((type).toString());
    }
