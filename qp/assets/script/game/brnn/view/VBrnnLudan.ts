...
export default class VBrnnLudan extends VBaseUI {
    ...
    onEnable() {
        ...
        AppGame.ins.brnnModel.on(MBrnn.GAMESCENE_STATUS_JETTON, this.onGameSceneStatusJetton, this);
        AppGame.ins.brnnModel.on(MBrnn.GAMESCENE_STATUS_OPEN, this.onGameSceneStatusOpen, this);
        AppGame.ins.brnnModel.on(MBrnn.GAMESCENE_STATUS_END, this.onGameSceneStatusEnd, this);

        AppGame.ins.brnnModel.on(MBrnn.S_SEND_RECORD, this.onGameRecord, this);
    }
    ...
    onDisable() {
        ...
        AppGame.ins.brnnModel.off(MBrnn.GAMESCENE_STATUS_JETTON, this.onGameSceneStatusJetton, this);
        AppGame.ins.brnnModel.off(MBrnn.GAMESCENE_STATUS_OPEN, this.onGameSceneStatusOpen, this);
        AppGame.ins.brnnModel.off(MBrnn.GAMESCENE_STATUS_END, this.onGameSceneStatusEnd, this);

        AppGame.ins.brnnModel.off(MBrnn.S_SEND_RECORD, this.onGameRecord, this);
    }
    ...
    onGameSceneStatusJetton(data: Brnn.CMD_Scene_StatusJetton) {
        this.initData(AppGame.ins.brnnModel.recordData);
    }
    ...
    updateUI() {
        let data = AppGame.ins.brnnModel.recordData;
