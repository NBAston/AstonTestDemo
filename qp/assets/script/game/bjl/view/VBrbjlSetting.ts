 ...
 */
@ccclass
export default class VBrbjlSetting extends VBaseUI {
    ...
    */
    init(): void {
        ...
        // this._muback= UNodeHelper.getComponent(this._node_bg, "musicbar/Background", cc.Sprite);
        // this._sdback= UNodeHelper.getComponent(this._node_bg, "soundbar/Background", cc.Sprite);
    ...
    private refreshData(): void {
        ...
        // if (this._musicBtn.IsOn != !AppGame.ins.setting.musicmute){
        ...
        // if (this._soundBtn.IsOn != !AppGame.ins.setting.soundmute){
