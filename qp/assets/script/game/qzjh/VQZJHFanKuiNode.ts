...
/**
 * 创建:dz
 * 作用:qzjh 反馈界面 not use
 */
@ccclass
export default class VQZJHFanKuiNode extends VBaseUI {
    ...
    start() {
        ...
        UEventHandler.addClick(close, this.node, "VQZJHFanKuiNode", "close");

        let btn_yes = UNodeHelper.find(this.node, "qznn_tips_btn2");
        UEventHandler.addClick(btn_yes, this.node, "VQZJHFanKuiNode", "onBtnYesClick");
