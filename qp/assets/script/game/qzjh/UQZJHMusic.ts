 ...
 * qznn的音乐播放器
 */
export default class UQZJHMusic {
    ...
    /**抢庄牛牛 牌型 */
    playPaiXing(cardtype: string, sex: number): void {
        var aniName = null;
        // if (cardtype < 11) {
        ...
        //     aniName = sex == 0 ? ("audio_jh_" + cardtype.toString()) : ("audio_qznn_woman_" + cardtype.toString());
        // }
    ...
    playGamebg(): void { 
        ...
        UAudioManager.ins.playGameMusic(AppGame.ins.roomModel.BundleName,"audio_qznn_bgm",true);
    }
    /**金币飞 */
    playflyCoin(): void {
