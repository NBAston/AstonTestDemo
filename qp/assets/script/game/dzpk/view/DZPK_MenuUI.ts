...
import DZPK_Model from "../model/DZPK_Model";
 ...
 * 菜单控制
 */
export default class DZPK_MenuUI {
    ...
    private on_shezhi(): void {
        AppGame.ins.showUI(ECommonUI.LB_Setting, EGameType.DZPK);
        this.closemenu();
        this._music.playclick();
    }
    private on_record(): void {
        AppGame.ins.showUI(ECommonUI.LB_Record, EGameType.DZPK);
        this.closemenu();
        this._music.playclick();
    }
    private on_wanfa(): void {
        AppGame.ins.showUI(ECommonUI.ZJH_Help, { gameType: EGameType.DZPK });
        this.closemenu();
        this._music.playclick();
    }
    ...
    constructor(root: cc.Node, menu: cc.Node, music: DZPK_Music) {
        this._music = music;
