...
@ccclass
export default class VBrlhXiaoluController extends cc.Component {
    @property(cc.Node)
   ...
   /**
    ...
    setTip(type: number,flag: number,isblink?:boolean){
        ...
        case 1:// 大眼仔路
            if(flag == 2) {
                tips[this.TipSpace[1]].getComponent(cc.Sprite).spriteFrame = this.spf_frames.getComponent('USpriteFrames').getFrames('lh_h_1');
            } else {
                tips[this.TipSpace[1]].getComponent(cc.Sprite).spriteFrame = this.spf_frames.getComponent('USpriteFrames').getFrames('lh_1');
            }
            break
        case 2:// 小路
            if(flag == 2) {
                tips[this.TipSpace[1]].getComponent(cc.Sprite).spriteFrame = this.spf_frames.getComponent('USpriteFrames').getFrames('lh_h_2');
            } else {
                tips[this.TipSpace[1]].getComponent(cc.Sprite).spriteFrame = this.spf_frames.getComponent('USpriteFrames').getFrames('lh_2');
            }
            break
        case 3:// 曱甴路
            if(flag == 2) {
                tips[this.TipSpace[1]].getComponent(cc.Sprite).spriteFrame = this.spf_frames.getComponent('USpriteFrames').getFrames('lh_h_3');
            } else {
                tips[this.TipSpace[1]].getComponent(cc.Sprite).spriteFrame = this.spf_frames.getComponent('USpriteFrames').getFrames('lh_3');
            }
            break
        }
        if(isblink) {
