...
@ccclass
export default class VTBNNRecordItem_hy extends cc.Component {
    ...
    setItemData(data: any, isWinner: boolean) {
        ...
        if (MTBNNModel_hy.ins.gBattlePlayer[data.userId]) {
            UResManager.load(MTBNNModel_hy.ins.gBattlePlayer[data.userId].headId, EIconType.Head, this.head, headImgUrl);
            UResManager.load(MTBNNModel_hy.ins.gBattlePlayer[data.userId].headboxId, EIconType.Frame, this.headFrame);
        }
    }
