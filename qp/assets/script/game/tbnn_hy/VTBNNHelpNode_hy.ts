 ...
 */
@ccclass
export default class VTBNNHelpNode_hy extends VBaseUI {// cc.Component {
    /**关闭按钮 */
    @property(cc.Button)
    ...
    onLoad() {
        ...
        this._toggle4 = UNodeHelper.getComponent(this.node,"qznn_toggleContainer/toggle4",cc.Toggle);

        UEventHandler.addToggle(this._toggle0.node,this.node,"VTBNNHelpNode_hy","onCheckEvent",0);
        UEventHandler.addToggle(this._toggle1.node,this.node,"VTBNNHelpNode_hy","onCheckEvent",1);
        UEventHandler.addToggle(this._toggle2.node,this.node,"VTBNNHelpNode_hy","onCheckEvent",2);
        UEventHandler.addToggle(this._toggle3.node,this.node,"VTBNNHelpNode_hy","onCheckEvent",3);
        UEventHandler.addToggle(this._toggle4.node,this.node,"VTBNNHelpNode_hy","onCheckEvent",4);
