 ...
 */
@ccclass
export default class VTBNNPinCard_hy extends cc.Component {
    ...
    setIsUp(b: boolean) {
        ...
        if(b)
        {
            UTBNNScene_hy.ins.getMusic.playSelect();
        }
    }
    get isUp(): boolean {
        return this._isUp;
        ...
        this.node.on(cc.Node.EventType.TOUCH_END, (event) => {
            ...
            if (!self._isUp) {
                ...
                if (!self._isLock) {
                    ...
                    MTBNNModel_hy.ins.emit(UTBNNHelper_hy.TBNN_SELF_EVENT.TBNN_PINPAI_ADD, self._cardvalue, self._index);
                }
            }
            else {
                ...
                MTBNNModel_hy.ins.emit(UTBNNHelper_hy.TBNN_SELF_EVENT.TBNN_PINPAI_DEL, self._cardvalue, self._index);
            }
