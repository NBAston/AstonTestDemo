...
import { ETBNNUITipType } from "./UTBNNHelper_hy";
 ...
 */
@ccclass
export default class VTBNNTipNode_hy extends VBaseUI {
    ...
    hideAction() {
        ...
        let callfunc = cc.callFunc(function () {
            AppGame.ins.closeUI(ECommonUI.TBNN_Tip);
        }, this);
    ...
    test() {
        ...
        AppGame.ins.showUI(ECommonUI.TBNN_Tip, data);
        ...
        AppGame.ins.showUI(ECommonUI.TBNN_Tip, data1);
        ...
        AppGame.ins.showUI(ECommonUI.TBNN_Tip, data2);
        ...
        AppGame.ins.showUI(ECommonUI.TBNN_Tip, data3);
