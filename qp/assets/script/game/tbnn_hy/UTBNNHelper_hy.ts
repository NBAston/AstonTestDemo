 ...
 */
// @ccclass
export default class UTBNNHelper_hy {

    static TBNN_SELF_EVENT = {
        TBNN_SHOW_TIME_OUT: "TBNN_SHOW_TIME_OUT",//超时消息
        TBNN_PRE_DISMISS: "TBNN_PRE_DISMISS",//预解散
        TBNN_HOST_AGAIN: "TBNN_HOST_AGAIN",//房主再来一局
        TBNN_SELF_AGAIN: "TBNN_SELF_AGAIN",//自己再来一局
        TBNN_CHAT_MESSAGE: "TBNN_CHAT_MESSAGE",//聊天消息
...
export class TBNNBattlePlayerInfo extends RoomPlayerInfo {
    ...
    /**玩家状态 */
    playStatus: number; //游戏中玩家  3-坐下(旁观)  4-准备 5-游戏中
    userId: number;
    /**是否退出 */
