...
export default class VTBNNMenu_hy {
    ...
    private on_leave(): void {
        ...
        if (MTBNNModel_hy.ins.roomInfoHy && AppGame.ins.roleModel.useId == MTBNNModel_hy.ins.roomInfoHy.roomUserId) {
    ...
    private on_shezhi(): void {
        ...
        AppGame.ins.showUI(ECommonUI.UI_SETTING_HY,
            { callback: MTBNNModel_hy.ins.sendSettingToggleRequest, roomInfo: MTBNNModel_hy.ins.roomInfoHy });
        this.closemenu();
    }
    ...
    private on_record(): void {
        UTBNNScene_hy.ins.playClick();
        AppGame.ins.showUI(ECommonUI.LB_Record, EGameType.TBNN);
    ...
    private onClickCheckout(): void {
        ...
        AppGame.ins.showUI(ECommonUI.NewMsgBox, {
            ...
            handler: UHandler.create((v: boolean) => {
                v && MTBNNModel_hy.ins.sendCheckout();
            })
        })
    }
    ...
    */
    showMenu(value: boolean): void {
        ...
        if (value == true) {
            if (MTBNNModel_hy.ins.roomInfoHy && MTBNNModel_hy.ins.roomInfoHy.roomUserId) {
                this.btn_checkout.active = MTBNNModel_hy.ins.roomInfoHy.roomUserId == AppGame.ins.roleModel.useId ? true : false;
            }
