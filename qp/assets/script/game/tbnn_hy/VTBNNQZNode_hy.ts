 ...
 */
@ccclass
export default class VTBNNQZNode_hy extends cc.Component {
    ...
    private init(): void {
        for (let i = 0; i < 3; i++) {
            let path = "node/qznn_btn" + (i + 1).toString() + "倍";
    ...
    private addEvent() {
        ...
        UEventHandler.addClick(this._btnBuQiang.node,
            this.node, "VTBNNQZNode_hy", "sendBeiShuInfo", 0);
        ...
        // MTBNNModel_hy.ins.on(UTBNNHelper_hy.TBNN_SELF_EVENT.TBNN_OPEN_QIANGZHUANG, this.openQiangZhuangPanel, this);
    ...
    private removeEvent(){
        ...
        // MTBNNModel_hy.ins.off(UTBNNHelper_hy.TBNN_SELF_EVENT.TBNN_OPEN_QIANGZHUANG, this.openQiangZhuangPanel, this);
    ...
    private sendBeiShuInfo(event, customEventData) {
        ...
        MTBNNModel_hy.ins.sendCallBanker(customEventData);
    }
    ...
    private onCallBanker(data: any) {
        ...
        // cc.log("gMeChairId :" + MTBNNModel_hy.ins.gMeChairId);
                ...
                if(this._qznnList[i.toString()]){
                    ...
                    if (cbCallBankerMultiple[i] > 0) {
                        ...
                        UEventHandler.addClick(this._qznnList[i.toString()].btn.node,
                            this.node, "VTBNNQZNode_hy", "sendBeiShuInfo", cbCallBankerMultiple[i]);
                    }
                    else {
