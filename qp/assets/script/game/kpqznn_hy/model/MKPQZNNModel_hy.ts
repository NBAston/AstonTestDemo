...
import UKPQZNNHelper_hy, { EQZNNState, QZNNBattlePlayerInfo, MAX_COUNT, OX_FIVE_SMALL, OX_GOLDEN_BULL, OX_BOMB, OX_SILVERY_BULL, OX_VALUE0 } from "../UKPQZNNHelper_hy";
import MBaseGameModel from "../../../public/hall/MBaseGameModel";
import { FKPQznn, Game } from "../../../common/cmd/proto";
import UHandler from "../../../common/utility/UHandler";
import UMsgCenter from "../../../common/net/UMsgCenter";
import { EGameType, ELeftType, ELevelType, ECommonUI, EMsgType, ERoomKind } from "../../../common/base/UAllenum";
 ...
 * 作用:qznn 主要逻辑
 */
export default class MKPQZNNModel_hy extends Model {
    // //大致流程  not use
    // group = {
    ...
    // add by zw
    // 2019年7月29日
    static s_ins: MKPQZNNModel_hy;
    static get ins(): MKPQZNNModel_hy {

        if (MKPQZNNModel_hy.s_ins == null) {
            MKPQZNNModel_hy.s_ins = new MKPQZNNModel_hy();
            MKPQZNNModel_hy.s_ins.init();
        }
        return MKPQZNNModel_hy.s_ins;
    }
    ...
    exit(): void {
        ...
        this.unregesterMsg(FKPQznn.SUBID.SC_GAMESCENE_FREE, new UHandler(this.onGameSceneFree, this));
        this.unregesterMsg(FKPQznn.SUBID.SC_GAMESCENE_CALL, new UHandler(this.onGameSceneCall, this));
        this.unregesterMsg(FKPQznn.SUBID.SC_GAMESCENE_SCORE, new UHandler(this.onGameSceneScore, this));
        this.unregesterMsg(FKPQznn.SUBID.SC_GAMESCENE_OPEN, new UHandler(this.onGameSceneOpen, this));
        this.unregesterMsg(FKPQznn.SUBID.SC_GAMESCENE_END, new UHandler(this.onGameSceneEnd, this));

        this.unregesterMsg(FKPQznn.SUBID.NN_SUB_S_ADD_SCORE_RESULT, new UHandler(this.onAddScoreResult, this));
        this.unregesterMsg(FKPQznn.SUBID.NN_SUB_S_CALL_BANKER, new UHandler(this.onCallBanker, this));
        this.unregesterMsg(FKPQznn.SUBID.NN_SUB_S_CALL_BANKER_RESULT, new UHandler(this.onCallBankerResult, this));
        this.unregesterMsg(FKPQznn.SUBID.NN_SUB_S_GAME_END, new UHandler(this.onGameEnd, this));
        this.unregesterMsg(FKPQznn.SUBID.NN_SUB_S_GAME_START, new UHandler(this.onGameStart, this));
        this.unregesterMsg(FKPQznn.SUBID.NN_SUB_S_OPEN_CARD_RESULT, new UHandler(this.onOpenCardResult, this));
        this.unregesterMsg(FKPQznn.SUBID.NN_SUB_S_SEND_CARD, new UHandler(this.onSendCard, this));

        this.unregesterMsg(FKPQznn.SUBID.NN_SUB_S_READY_RESULT, new UHandler(this.onReady, this)); //准备
        this.unregesterMsg(FKPQznn.SUBID.NN_SUB_S_MESSAGE_RESULT, new UHandler(this.onChatMessage, this));  //聊天消息
        this.unregesterMsg(FKPQznn.SUBID.NN_SUB_S_AGAIN_RESULT, new UHandler(this.onPlayAgain, this));  //再来一轮
        this.unregesterMsg(FKPQznn.SUBID.NN_SUB_S_PRE_DISSMIS_RESULT, new UHandler(this.onPreDismiss, this));  //预解散房间
        this.unregesterMsg(FKPQznn.SUBID.NN_SUB_S_DISSMIS_RESULT, new UHandler(this.onDismiss, this));  //解散房间
        this.unregesterMsg(FKPQznn.SUBID.NN_SUB_S_LOOKON_RESULT, new UHandler(this.onLookOn, this));  //旁观
        this.unregesterMsg(FKPQznn.SUBID.NN_SUB_S_CONCLUDE_RESULT, new UHandler(this.onAheadCheckout, this));  //提前结算
        this.unregesterMsg(FKPQznn.SUBID.NN_SUB_S_CHANGE_USER_STATUS, new UHandler(this.onCheckoutChangeStatus, this));  //一局结算后，玩家状态切换        
        this.unregesterMsg(FKPQznn.SUBID.NN_SUB_S_IDLE_TIMEOUT_RESULT, new UHandler(this.onTimeOutResult, this)); //15分钟超时消息

        this.unregesterMsg(FKPQznn.SUBID.NN_SUB_S_SET_IP_LIMIT_RESULT, new UHandler(this.onIpLimit, this));  //ip限制
        this.unregesterMsg(FKPQznn.SUBID.NN_SUB_S_SET_SCORE_LIMIT_RESULT, new UHandler(this.onBringInLimit, this));  //控制带入
        this.unregesterMsg(FKPQznn.SUBID.NN_SUB_C_SET_CHAT_LIMIT_RESULT, new UHandler(this.onChatLimit, this));  //聊天限制
        this.unregesterMsg(FKPQznn.SUBID.NN_SUB_S_SET_AUTO_START_RESULT, new UHandler(this.onAutoStartLimit, this));  //自动开局
        this.unregesterMsg(FKPQznn.SUBID.NN_SUB_S_SET_PLAYER_NUM_LIMIT_RESULT, new UHandler(this.onPlayerNumLimit, this));  //开局人数
    ...
    //#region 协议相关
    qznnRegest() {
        this.regesterMsg(FKPQznn.SUBID.NN_SUB_S_IDLE_TIMEOUT_RESULT, new UHandler(this.onTimeOutResult, this)); //15分钟超时消息

        this.regesterMsg(FKPQznn.SUBID.SC_GAMESCENE_FREE, new UHandler(this.onGameSceneFree, this));
        this.regesterMsg(FKPQznn.SUBID.SC_GAMESCENE_CALL, new UHandler(this.onGameSceneCall, this));
        this.regesterMsg(FKPQznn.SUBID.SC_GAMESCENE_SCORE, new UHandler(this.onGameSceneScore, this));
        this.regesterMsg(FKPQznn.SUBID.SC_GAMESCENE_OPEN, new UHandler(this.onGameSceneOpen, this));
        this.regesterMsg(FKPQznn.SUBID.SC_GAMESCENE_END, new UHandler(this.onGameSceneEnd, this));

        this.regesterMsg(FKPQznn.SUBID.NN_SUB_S_ADD_SCORE_RESULT, new UHandler(this.onAddScoreResult, this));
        this.regesterMsg(FKPQznn.SUBID.NN_SUB_S_CALL_BANKER, new UHandler(this.onCallBanker, this));
        this.regesterMsg(FKPQznn.SUBID.NN_SUB_S_CALL_BANKER_RESULT, new UHandler(this.onCallBankerResult, this));
        this.regesterMsg(FKPQznn.SUBID.NN_SUB_S_GAME_END, new UHandler(this.onGameEnd, this));
        this.regesterMsg(FKPQznn.SUBID.NN_SUB_S_GAME_START, new UHandler(this.onGameStart, this));
        this.regesterMsg(FKPQznn.SUBID.NN_SUB_S_OPEN_CARD_RESULT, new UHandler(this.onOpenCardResult, this));
        this.regesterMsg(FKPQznn.SUBID.NN_SUB_S_SEND_CARD, new UHandler(this.onSendCard, this));

        this.regesterMsg(FKPQznn.SUBID.NN_SUB_S_READY_RESULT, new UHandler(this.onReady, this));  //准备
        this.regesterMsg(FKPQznn.SUBID.NN_SUB_S_MESSAGE_RESULT, new UHandler(this.onChatMessage, this));  //发送消息
        this.regesterMsg(FKPQznn.SUBID.NN_SUB_S_AGAIN_RESULT, new UHandler(this.onPlayAgain, this));  //再来一轮
        this.regesterMsg(FKPQznn.SUBID.NN_SUB_S_PRE_DISSMIS_RESULT, new UHandler(this.onPreDismiss, this));  //预解散房间
        this.regesterMsg(FKPQznn.SUBID.NN_SUB_S_DISSMIS_RESULT, new UHandler(this.onDismiss, this));  //解散房间
        this.regesterMsg(FKPQznn.SUBID.NN_SUB_S_LOOKON_RESULT, new UHandler(this.onLookOn, this));  //旁观
        this.regesterMsg(FKPQznn.SUBID.NN_SUB_S_CONCLUDE_RESULT, new UHandler(this.onAheadCheckout, this));  //提前结算
        this.regesterMsg(FKPQznn.SUBID.NN_SUB_S_CHANGE_USER_STATUS, new UHandler(this.onCheckoutChangeStatus, this));  //一局结算后，玩家状态切换

        this.regesterMsg(FKPQznn.SUBID.NN_SUB_S_SET_IP_LIMIT_RESULT, new UHandler(this.onIpLimit, this));  //ip限制
        this.regesterMsg(FKPQznn.SUBID.NN_SUB_S_SET_SCORE_LIMIT_RESULT, new UHandler(this.onBringInLimit, this));  //控制带入
        this.regesterMsg(FKPQznn.SUBID.NN_SUB_C_SET_CHAT_LIMIT_RESULT, new UHandler(this.onChatLimit, this));  //聊天限制
        this.regesterMsg(FKPQznn.SUBID.NN_SUB_S_SET_AUTO_START_RESULT, new UHandler(this.onAutoStartLimit, this));  //自动开局
        this.regesterMsg(FKPQznn.SUBID.NN_SUB_S_SET_PLAYER_NUM_LIMIT_RESULT, new UHandler(this.onPlayerNumLimit, this));  //开局人数
    ...
    onGameToBack(isBack: boolean) {
        if (!isBack) {
            ...
            this.sendMsg(FKPQznn.SUBID.CS_GAMESCENE_FRESH, {});
        }
    }

    /**注册qznn网络消息事件 */
    regesterMsg(subId: number, handler: UHandler) {
        UMsgCenter.ins.regester(EGameType.KPQZNN_HY,
    ...
    unregesterMsg(subId: number, handler: UHandler) {
        UMsgCenter.ins.unregester(EGameType.KPQZNN_HY,
            Game.Common.MAINID.MAIN_MESSAGE_CLIENT_TO_GAME_LOGIC_FRIEND,
            subId,
            handler);
    }
    ...
    sendMsg(subId: number, data: any, handler: UHandler = null, unlock: boolean = false) {
        UMsgCenter.ins.sendPkg(EGameType.KPQZNN_HY,
            Game.Common.MAINID.MAIN_MESSAGE_CLIENT_TO_GAME_LOGIC_FRIEND,
    ...
    /**
     * 设置所有场景内玩家状态
     * @param gameStatus MKPQZNNModel_hy.QZNN_GAMESTATUS状态
    ...
    private setAllSceneStatus(gameStatus: number, state: EQZNNState, cbPlayStatus?: number[]) {
        ...
        this._gameStatus = MKPQZNNModel_hy.QZNN_GAMESTATUS.FREE;
        //如果是上座玩牌玩家，重新赋状态
        if (this._battleplayer[this.selfUserId] != null
            ...
            this._gameStatus = gameStatus;//MKPQZNNModel_hy.QZNN_GAMESTATUS.CALL;
        }
    }
    /**设置房间内玩家信息 */
    ...
    public updateBattlePlayer() {
        this.emit(UKPQZNNHelper_hy.QZNN_SELF_EVENT.QZNN_UPDATE_PLAYERS_EVENT, this._battleplayer);
    }
    ...
    private onGameSceneFree(data: any) {
        ...
        this.emit(UKPQZNNHelper_hy.QZNN_EVENT.QZNN_GAMESCENE_FREE, data, ishideContinue);
        this.updateBattlePlayer();
    ...
    onGameSceneCall(data: any) {
        ...
        this.setAllSceneStatus(MKPQZNNModel_hy.QZNN_GAMESTATUS.CALL, EQZNNState.Gameing, cbPlayStatus);
        this.emit(UKPQZNNHelper_hy.QZNN_EVENT.QZNN_GAMESCENE_CALL, data);
        this.updateBattlePlayer();
        this.emit(UKPQZNNHelper_hy.QZNN_SELF_EVENT.QZNN_UPDATE_ROOMID, roomId);
    ...
    onGameSceneScore(data: any) {
        ...
        this.setRoomPlayersInfo();
        this.setAllSceneStatus(MKPQZNNModel_hy.QZNN_GAMESTATUS.SCORE, EQZNNState.Gameing, cbPlayStatus);
        this.emit(UKPQZNNHelper_hy.QZNN_EVENT.QZNN_GAMESCENE_SCORE, data);
        this.updateBattlePlayer();
        this.emit(UKPQZNNHelper_hy.QZNN_SELF_EVENT.QZNN_UPDATE_ROOMID, roomId);
        this._dataSceneTemp = null;
        this._sceneNum = 0;
    ...
    onGameSceneOpen(data: any) {
        ...
        this.setAllSceneStatus(MKPQZNNModel_hy.QZNN_GAMESTATUS.OPEN, EQZNNState.Gameing, cbPlayStatus);

        this.emit(UKPQZNNHelper_hy.QZNN_EVENT.QZNN_GAMESCENE_OPEN, data);
    ...
    onGameSceneEnd(data: FKPQznn.NN_MSG_GS_END) {
        ...
        this.emit(UKPQZNNHelper_hy.QZNN_EVENT.QZNN_GAMESCENE_END, data);
    }
    ...
    setRoomHyInfo(data: any) {
        ...
        if (data.roomInfo.allRound > 0) {
            MKPQZNNModel_hy.ins.roomType = 1;
        } else if (data.roomInfo.allSeconds > 0) {
            MKPQZNNModel_hy.ins.roomType = 2;
        }
    }

    // onGameSceneEnd(data) {
    //  this.emit(QZNN_SC_GAMESCENE_END, data);
    // }
    ...
    private onUserEnterNotify(data: any) {
        ...
        // this.emit(UKPQZNNHelper_hy.QZNN_SELF_EVENT.QZNN_UPDATE_PLAYERS_EVENT, this._roomPlayers);
    }
    ...
    private sc_ts_player_left_room(data: any) {
        ...
        if (data.retCode == 0) {
            if (data.type == ELeftType.ReturnToRoom) {
                ...
                AppGame.ins.loadLevel(ELevelType.Hall, EGameType.KPQZNN_HY);
            } else if (data.type == ELeftType.CancleMatch) {
                this.emit(UKPQZNNHelper_hy.QZNN_SELF_EVENT.QZNN_SC_TS_CANCLE_MATCH, true);
                this._state = EQZNNState.Wait;
                ...
                this.emit(UKPQZNNHelper_hy.QZNN_SELF_EVENT.QZNN_SC_TS_START_MATCH, true);
            }

        }
        // else if (data.retCode == 2) {
        //     this.emit(UKPQZNNHelper_hy.QZNN_SELF_EVENT.QZNN_CONTINUE_ACTIVE, true);
        // }
        else {
            this._retrunLobby = false;
            ...
            if (data.type == ELeftType.ReturnToRoom) {
                ...
                if (this._state != EQZNNState.Gameing) {
                    this.emit(UKPQZNNHelper_hy.QZNN_SELF_EVENT.QZNN_SC_TS_CANCLE_MATCH, false);
                }
                if (data.errorMsg) {
                    AppGame.ins.showTips(ULanHelper.SG_CANT_EXIT_GAME);
                }
                ...
                this.emit(UKPQZNNHelper_hy.QZNN_SELF_EVENT.QZNN_SC_TS_START_MATCH, false);
            }
    ...
    sendChatMsg(faceId: number, msgbody: string, type: number) {
        ...
        MKPQZNNModel_hy.ins.sendMsg(FKPQznn.SUBID.NN_SUB_C_MESSAGE, data);
    }
    ...
    private onTimeOutResult(data: any) {
        if (data.retCode == 0) {
            if (data.idleLeave <= 0) {
                ...
                this.emit(UKPQZNNHelper_hy.QZNN_SELF_EVENT.QZNN_SHOW_TIME_OUT, data);
            }
        }
    }
    ...
    private onChatMessage(data: any) {
        ...
        this.emit(UKPQZNNHelper_hy.QZNN_SELF_EVENT.QZNN_CHAT_MESSAGE, data)
    }
    ...
    private onPlayAgain(data: any) {
        if (data.retCode == 0) {
            if (data.userId == this.roomInfoHy.roomUserId && data.roomInfo) {
                this._roomInfoHy = data.roomInfo;
                this.isHostAgain = true;
                this.emit(UKPQZNNHelper_hy.QZNN_SELF_EVENT.QZNN_HOST_AGAIN, data);
            ...
            if (data.userId == AppGame.ins.roleModel.useId) {
                this.isSelfAgain = true;
                this.emit(UKPQZNNHelper_hy.QZNN_SELF_EVENT.QZNN_SELF_AGAIN, data);
    ...
    private onPreDismiss(data: any) {
        if (data.retCode == 0) {
            ...
            this.updateBattlePlayer();
            this.emit(UKPQZNNHelper_hy.QZNN_SELF_EVENT.QZNN_PRE_DISMISS, data);
            AppGame.ins.showBundleUI(ECommonUI.Game_record_kpqznn_hy, EGameType.KPQZNN_HY, { leaveTime: data.dissmissTimeLeave, reuse: true });
    ...
    /**一局结算后，玩家状态切换 */
    onCheckoutChangeStatus(data: any) {
        this.setRoomPlayersInfo();
        if (this.isHostAgain) {
    ...
    sendSettingToggleRequest(type: number, param: any) {
        switch (type) {
            case 1:
                MKPQZNNModel_hy.ins.sendMsg(FKPQznn.SUBID.NN_SUB_C_SET_IP_LIMIT, { bLimit: param });
                break;
            case 2:
                MKPQZNNModel_hy.ins.sendMsg(FKPQznn.SUBID.NN_SUB_C_SET_SCORE_LIMIT, { bLimit: param });
                break;
            case 5:
                MKPQZNNModel_hy.ins.sendMsg(FKPQznn.SUBID.NN_SUB_C_SET_AUTO_START, { bAutoStart: param });
                break;
            case 4:
                MKPQZNNModel_hy.ins.sendMsg(FKPQznn.SUBID.NN_SUB_C_SET_CHAT_LIMIT, { bLimit: param });
                break;
            case 3:
                MKPQZNNModel_hy.ins.sendMsg(FKPQznn.SUBID.NN_SUB_C_SET_PLAYER_NUM_LIMIT, { playerNumLimit: param });
                break;
            default:
                break;
        }
    ...
    onGameStart(data: any) {
        ...
        this.emit(UKPQZNNHelper_hy.QZNN_EVENT.QZNN_GAME_START, data);
        this.updateBattlePlayer();
        this.emit(UKPQZNNHelper_hy.QZNN_SELF_EVENT.QZNN_UPDATE_ROOMID, roomId);
    }
    ...
    onCallBanker(data: any) {
        this.emit(UKPQZNNHelper_hy.QZNN_EVENT.QZNN_CALL_BANKER, data);
        this._state = EQZNNState.Gameing;
    }

    /**叫庄结果 */
    onCallBankerResult(data: any) {
        this.emit(UKPQZNNHelper_hy.QZNN_EVENT.QZNN_CALL_BANKER_RESULT, data);
        this._state = EQZNNState.Gameing;
    ...
    onAddScoreResult(data: any) {  // private
        ...
        this.emit(UKPQZNNHelper_hy.QZNN_EVENT.QZNN_ADD_SCORE_RESULT, data);
        this._state = EQZNNState.Gameing;
    ...
    /**发牌消息 */
    onSendCard(data: any) {
        this.emit(UKPQZNNHelper_hy.QZNN_EVENT.QZNN_SEND_CARD, data);
        this._state = EQZNNState.Gameing;
    ...
    onOpenCardResult(data: any) {
        this.emit(UKPQZNNHelper_hy.QZNN_EVENT.QZNN_OPEN_CARD_RESULT, data);
        this._state = EQZNNState.Gameing;
    }
    ...
    onGameEnd(data: any) {
        ...
        this.emit(UKPQZNNHelper_hy.QZNN_EVENT.QZNN_GAME_END, data);
        this.emit(UKPQZNNHelper_hy.QZNN_SELF_EVENT.QZNN_DJS_EVENT, 0);
    ...
    onNextExit(data: any) {
        UDebug.log(data);
        this.emit(UKPQZNNHelper_hy.QZNN_SELF_EVENT.QZNN_NEXT_EXIT, data);
    }
    ...
    /**准备 */
    sendReady() {
        this.sendMsg(FKPQznn.SUBID.NN_SUB_C_READY, {});
    }

    /**旁观 */
    sendLookOn() {
        this.sendMsg(FKPQznn.SUBID.NN_SUB_C_LOOKON, {});
    }

    /**下局旁观 */
    sendLookOnNext(isLookOn: boolean) {
        this.sendMsg(FKPQznn.SUBID.NN_SUB_C_NEXT_LOOKON, {
            bLookon: isLookOn
        });
    }
    ...
    /**结算 */
    sendCheckout() {
        this.sendMsg(FKPQznn.SUBID.NN_SUB_C_CONCLUDE, {});
    }

    /**再来一轮 */
    sendPlayAgain() {
        this.sendMsg(FKPQznn.SUBID.NN_SUB_C_AGAIN, {});
    }
    ...
    sendAddScore(jetton: number) {
        ...
        this.sendMsg(FKPQznn.SUBID.NN_SUB_C_ADD_SCORE, data);
    }
    /**
     * 请求叫庄
     * @param callFlag 
    ...
    sendCallBanker(callFlag: number) {
        ...
        this.sendMsg(FKPQznn.SUBID.NN_SUB_C_CALL_BANKER, data);
    }

    /**请求开牌 */
    sendOpenCard() {
        this.sendMsg(FKPQznn.SUBID.NN_SUB_C_OPEN_CARD, {});
    }
    ...
    sendNextExit(b: boolean): void {
        ...
        // this.sendMsg(FKPQznn.SUBID.NN_SUB_C_ROUND_END_EXIT, data);
    }
    ...
    public getCardSuit(card: number): number {
        return (card & MKPQZNNModel_hy.LOGIC_MASK.COLOR) >> 4;
    }
    /**获取一副完整的牌 not use*/
    ...
    public getCardValue(card: number): number {
        return card & MKPQZNNModel_hy.LOGIC_MASK.VALUE;
    }
