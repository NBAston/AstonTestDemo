...
import { EQZNNUITipType } from "./UKPQZNNHelper_hy";
 ...
 */
@ccclass
export default class VKPQZNNTipNode_hy extends VBaseUI {
    ...
    hideAction() {
        ...
        let callfunc = cc.callFunc(function () {
            AppGame.ins.closeUI(ECommonUI.QZNN_Tip);
        }, this);
    ...
    test() {
        ...
        AppGame.ins.showUI(ECommonUI.QZNN_Tip, data);
        ...
        AppGame.ins.showUI(ECommonUI.QZNN_Tip, data1);
        ...
        AppGame.ins.showUI(ECommonUI.QZNN_Tip, data2);
        ...
        AppGame.ins.showUI(ECommonUI.QZNN_Tip, data3);
