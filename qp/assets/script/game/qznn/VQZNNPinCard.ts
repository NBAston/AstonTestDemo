 ...
 */
@ccclass
export default class VQZNNPinCard extends cc.Component {
        ...
        this.node.on(cc.Node.EventType.TOUCH_END, (event) => {
            ...
            if (!self._isUp) {
                ...
                if (!self._isLock) {
                    ...
                    AppGame.ins.qznnModel.emit(UQZNNHelper.QZNN_SELF_EVENT.QZNN_PINPAI_ADD, self._cardvalue, self._index);
                }
            }
            else {
                ...
                AppGame.ins.qznnModel.emit(UQZNNHelper.QZNN_SELF_EVENT.QZNN_PINPAI_DEL, self._cardvalue, self._index);
            }
