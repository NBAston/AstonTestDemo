...
import { EQZNNUIzIndex } from "./UQZNNHelper";
 ...
 */
@ccclass
export default class VQZNNSMNode extends VBaseUI {
    ...
    start () {
        ...
        UEventHandler.addClick(btn_close, this.node, "VQZNNSMNode", "onBtnCloseClick");
    ...
    show(data:any){
        ...
        AppGame.ins.qznnModel.sIsOpenSM = true;
    }
