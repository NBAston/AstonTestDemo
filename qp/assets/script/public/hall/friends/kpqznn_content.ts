...
@ccclass
export default class kpqznn_content extends cc.Component {
    ...
    onLoad () {
        ...
        UEventHandler.addClick(this._ip_limit_btn,this.node,"kpqznn_content","show_tip_info",ULanHelper.GAME_HELP_TIP_HY.ZHJ_IP_LIMIT_SCORE);
        UEventHandler.addClick(this._turn_creat_btn,this.node,"kpqznn_content","turn_creat_room");
        this._auto_ready_btn = UNodeHelper.find(this.node,"time_content/btn_auto_limit");
        UEventHandler.addClick(this._auto_ready_btn,this.node,"kpqznn_content","show_tip_info",ULanHelper.GAME_HELP_TIP_HY.ZHJ_AUTO_READY);
        ...
        UEventHandler.addClick(this._auto_start_btn,this.node,"kpqznn_content","show_tip_info",ULanHelper.GAME_HELP_TIP_HY.ZHJ_AUTO_START);
        UEventHandler.addClick(this.btn_chat_limit,this.node,"kpqznn_content","show_tip_info",ULanHelper.GAME_HELP_TIP_HY.ZHJ_FORBID_CHAT);
        this._time_creat_btn = UNodeHelper.find(this.node,"time_content/btn_creat");
        UEventHandler.addClick(this._time_creat_btn,this.node,"kpqznn_content","time_creat_room");
    ...
    //     }
    //     AppGame.ins.roomModel.requestCreatRoom(14,"看牌抢庄牛牛",turn,0,a,isLimit,0,1,0);
    // }
    ...
    private time_creat_room():void{
        ...
        AppGame.ins.roomModel.requestCreatRoom(14,"看牌抢庄牛牛",0,time,autoStart,a,isLimit,0,1,0,chatLimit);
    }
    ...
    private turn_auto_slider():void{
        this._turn_auto_slider.node.getChildByName("progressBar").getComponentInChildren(cc.Sprite).fillRange= this._turn_auto_slider.progress;
        if(this._turn_auto_slider.node.getChildByName("progressBar").getComponentInChildren(cc.Sprite).fillRange == 0){
            this._turn_auto_number.string = "否";
        }else if(this._turn_auto_slider.node.getChildByName("progressBar").getComponentInChildren(cc.Sprite).fillRange == 1){
