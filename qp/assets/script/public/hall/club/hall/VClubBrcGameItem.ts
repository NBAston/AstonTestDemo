...
@ccclass
export default class VClubBrcGameItem extends cc.Component {
    ...
    init(data: any) {
        ...
        let path = "common/hall/ani/club/gameIconSpine/brc/" + data.gameInfo.abbreviateName + "/" + data.gameInfo.clubGameSpine;
